...
As a lab instructor for CSC1100, I built **RewardKeeper** to automate the reward calculation process. Professor Nasser provided the reward structure and rules; this tool implements them so that lab instructors can compute rewards by uploading gradesheet CSVs each week instead of manually tallying points.
